...
Its first priority is understanding:
...
- Detect risks
- Validate Playwright best practices
- Recommend better test data
- Evaluate localization & Unicode coverage
- Evaluate negative testing
- Evaluate boundary testing
...
- Performing QA risk analysis

The project focuses on quality engineering rather than code generation.